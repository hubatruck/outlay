            ...
            <div class="uk-margin">
              ...
              <div class="uk-form-controls">
                <div class="uk-inline uk-width-1-1">
                  ...
                  <input class="uk-input" type="name" name="name" value="{{ old('name') }}" required autofocus/>
                </div>
              </div>
            </div>
            ...
            <div class="uk-margin">
              ...
              <div class="uk-form-controls">
                <div class="uk-inline uk-width-1-1">
                  ...
                  <input class="uk-input" type="password" name="password" required autocomplete="current-password"/>
                </div>
              </div>
            </div>
