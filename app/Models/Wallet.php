...
class Wallet extends Model
{
    ...
    public static function everyPublicWallet(): Collection
    {
        ...
        return Auth::user()->wallets()
            ->orWhere('is_public', '=', 1)
            ->get()
            ->sortBy(fn (Wallet $wallet) => $wallet->user_id !== $userID);
    }
     ...
     *
     * @return HasMany<Transaction, Wallet>
     */
     ...
     *
     * @return HasMany<Transfer,Wallet>
     */
     ...
     *
     * @return HasMany<Transfer, covariant Wallet>
     */
     ...
     */
    public function getBalanceBetween(\Carbon\Carbon|string|null $from = null, \Carbon\Carbon|string|null $to = null): float
    {
